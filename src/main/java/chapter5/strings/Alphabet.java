...
/**
 *  for strings taken from a restricted alphabet
 */
public class Alphabet {
    ...
    private int[] indices;       // reverse index: char -> index
    ...
    public Alphabet(String alpha) {
        ...
        Arrays.fill(indices, NOT_IN_ALPHABET);
    ...
    /**
     * Initializes a new alphabet using characters 0 ~ R-1.
     *
    ...
    public boolean contains(char c) {
        return indices[c] != NOT_IN_ALPHABET;
    }
    ...
    public int toIndex(char c) {
        if (c >= indices.length || indices[c] == NOT_IN_ALPHABET) {
