 ...
 */
public class HeapBasedMaxPriorityQueue<T extends Comparable<T>> extends HeapBasedPriorityQueue<T> implements MaxPriorityQueue<T> {
    ...
    @SuppressWarnings("unused")
    public HeapBasedMaxPriorityQueue(int capacity) {
        super(capacity);
    }

    public HeapBasedMaxPriorityQueue(T[] arr) {
        super(arr);
    }
